...
// TODO  valores de fabrica de dispositivo
...
void settingsReset(){
    ...
    strlcpy(wifi_ssid, "drago", sizeof(wifi_ssid));
    strlcpy(wifi_password, "drago84", sizeof(wifi_password));
    ...
    // -------------------------------------------------------------------
    mqtt_enable = false;
    strlcpy(mqtt_server, "192.168.0.100", sizeof(mqtt_server));
    mqtt_port = 1883;
    mqtt_retain = false;
    mqtt_qos = 0;
